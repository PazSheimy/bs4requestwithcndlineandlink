...
sites = {
    ...
    "books": "www.gutenberg.org/ebooks/search/?submit_search=Go%21&query="
...
def build_url(site, searchterm):
   ...
   # print(f'https://{sites[site]}{"_".join(searchterm.split())}')
   # return f'https://{sites[site]}{"_".join(searchterm.split())}'
